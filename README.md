...
## Installing
```
curl -s https://raw.githubusercontent.com/deadlyug/otoressl/v1.2.2/install | bash
```

#### For UNTAD Admin
```
curl -s https://raw.githubusercontent.com/deadlyug/otoressl/v1.2.2/install-untad-admin | bash
```
...
## Uninstall
```
curl -s https://raw.githubusercontent.com/deadlyug/otoressl/v1.2.2/uninstall | bash
```
